...
#SBATCH --job-name=llama3_full      # 作业名称
#SBATCH --account=PAS2473		    # Project ID
#SBATCH --output=/users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/new_output_logs/llama3_full.log         # 输出日志文件
#SBATCH --error=/users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/new_output_logs/llama3_full_error.log          # 错误日志文件
#SBATCH --nodes=1                   # 节点数
...
python /users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/eval_long_bench.py --model Meta-Llama-3-8B_full_llama3 --e 
