...
#SBATCH --job-name=falcon_drop      # 作业名称
#SBATCH --account=PAS2473		    # Project ID
#SBATCH --output=/users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/new_output_logs/falcon_drop.log         # 输出日志文件
#SBATCH --error=/users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/new_output_logs/falcon_drop_error.log          # 错误日志文件
#SBATCH --nodes=1                   # 节点数
...
CUDA_VISIBLE_DEVICES=0 python /users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/run_pred_long_bench.py --model_name_or_path tiiuae/falcon-7b-instruct \
    ...
    --hh_ratio 0.0 \
    --recent_ratio 0.2 \
    --action_name falcon_drop \
    --e True 

python /users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/eval_long_bench.py --model falcon-7b-instruct_falcon_drop --e 
