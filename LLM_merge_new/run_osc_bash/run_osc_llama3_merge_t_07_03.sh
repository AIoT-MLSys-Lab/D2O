...
#SBATCH --job-name=3_8B_t_07_03      # 作业名称
#SBATCH --account=PAS2473		    # Project ID
#SBATCH --output=/users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/new_output_logs/3_8B_t_07_03.log         # 输出日志文件
#SBATCH --error=/users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/new_output_logs/3_8B_t_07_03_error.log          # 错误日志文件
#SBATCH --nodes=1                   # 节点数
...
CUDA_VISIBLE_DEVICES=0 python /users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/run_pred_long_bench.py --model_name_or_path meta-llama/Meta-Llama-3-8B \
    ...
    --hh_ratio 0.10 \
    --recent_ratio 0.10 \
    --action_name merge_llama3_t_03_07 \
    --alpha 0.3 \
    --belta 0.7 \
    --e True 

python /users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/eval_long_bench.py --model Meta-Llama-3-8B_merge_llama3_t_03_07 --e 
