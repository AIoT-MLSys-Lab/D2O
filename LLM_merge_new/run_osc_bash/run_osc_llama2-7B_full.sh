...
#SBATCH --job-name=llama2_full      # 作业名称
#SBATCH --account=PAS2473		    # Project ID
#SBATCH --output=/users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/new_output_logs/llama2_full.log         # 输出日志文件
#SBATCH --error=/users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/new_output_logs/llama2_full_error.log          # 错误日志文件
#SBATCH --nodes=1                   # 节点数
...
CUDA_VISIBLE_DEVICES=0 python /users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/run_pred_long_bench.py --model_name_or_path meta-llama/Llama-2-7b-hf \
    ...
    --model_type llama \
    --use_full True \
    --action_name full_llama2 \
    --e True 

python /users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/eval_long_bench.py --model Llama-2-7b-hf_full_llama2 --e 
