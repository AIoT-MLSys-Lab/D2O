...
#SBATCH --job-name=F_005_015     # 作业名称
#SBATCH --account=PAS2473		    # Project ID
#SBATCH --output=/users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/new_output_logs/F_005_015.log         # 输出日志文件
#SBATCH --error=/users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/new_output_logs/F_005_015_error.log          # 错误日志文件
#SBATCH --nodes=1                   # 节点数
...
python /users/PAS2473/brucewan666/Efficient_LLMs/LLM_merge_new/eval_long_bench.py --model falcon-7b-instruct_falcon_merge_005_015 --e 
