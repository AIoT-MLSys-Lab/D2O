...
#SBATCH --job-name=coqa_h2o_0.8     # 作业名称
#SBATCH --account=PAS2473		    # Project ID
#SBATCH --output=/users/PAS2473/brucewan666/xjwu/LLM_merge/output_logs_0503/coqa_h2o_0.8.log        # 输出日志文件
#SBATCH --error=/users/PAS2473/brucewan666/xjwu/LLM_merge/output_logs_0503/coqa_h2o_0.8_error.log         # 错误日志文件
#SBATCH --nodes=1                   # 节点数
